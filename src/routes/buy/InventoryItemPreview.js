...
export default function InventoryItemPreview({ inventoryItem }) {
  ...
  if (isItemPreview) {
    ...
    return (
      <div
        className="flex flex-row  md:flex-col justify-evenly text-center w-screen md:w-80 bg-blue-500 rounded m-1 p-1 text-white text-xl h-40 md:h-auto md:self-start"
        onClick={() => {
